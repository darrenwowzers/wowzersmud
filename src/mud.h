...
typedef enum
{
   ...
   CON_ACCOUNT_DELETE_PROMPT, CON_ACCOUNT_DELETE_PWD,
   CON_GET_NAME, CON_GET_OLD_PASSWORD, CON_CONFIRM_NEW_NAME,
   CON_GET_NEW_PASSWORD, CON_CONFIRM_NEW_PASSWORD,
   CON_GET_NEW_SEX, CON_GET_FACTION, CON_GET_NEW_CLASS, CON_READ_MOTD,
...
typedef enum
{
   ...
   APPLY_TELEDELAY, APPLY_DOT, APPLY_HOT, MAX_APPLY_TYPE
} apply_types;
...
void info_chan( const char *fmt, ... ) __attribute__((format(printf, 1, 2)));
